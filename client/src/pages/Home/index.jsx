...
function Home() {
  const [filters, setFilters] = useState({ search: "" , type: "" , dorminhabitants: "" });
  ...
  useEffect(() => {
    getData();
  }, [filters.type , filters.dorminhabitants]);
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between text-sm">
                <span>Dorm Inhabitants</span>
                <span className="capitalize">{movie?.dorminhabitants}</span>
              </div>
