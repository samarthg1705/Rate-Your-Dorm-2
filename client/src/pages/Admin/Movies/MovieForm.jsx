        ...
        <Tabs>
          <Tabs.TabPane tab="Details" key="1">
            ...
            >
              ...
              <Form.Item label="About" name="plot" rules={antValidationError}>
                <textarea />
              </Form.Item>

              <div className="grid grid-cols-3 gap-5">
                <Form.Item label="University" name="hero" rules={antValidationError}>
                ...
                >
                  <Select
                    options={[
                      {
                        label: "Traditional dormitory",
                        value: "action",
                      },
                      {
                        label: "Suite-style dorms",
                        value: "comedy",
                      },
                      {
                        label: "Apartment-style housing",
                        value: "drama",
                      },
                      {
                        label: "Single rooms",
                      ...
                      {
                        label: "Theme-based housing",
                        value: "theme",
                      },
                      {
                        label: "Fraternity/sorority housing",
                        value: "frat",
                      },
                      {
                        label: "Graduate or family housing",
                        value: "graduate",
                      },
                      {
